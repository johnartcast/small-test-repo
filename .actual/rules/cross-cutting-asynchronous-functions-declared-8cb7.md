# Adopt Async/Await as Standard Concurrency Model for Asynchronous Operations: Asynchronous Functions Declared
...
- **R-ASYNC-001** MUST: All asynchronous functions MUST be declared with the async keyword and use await for promise resolution rather than .then() chains or callbacks.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. All asynchronous functions must be verified to use async/await syntax with proper error handling before acceptance.
</enforcement>