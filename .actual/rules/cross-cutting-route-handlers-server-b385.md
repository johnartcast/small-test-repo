...
- **R-ASYNC-001** SHOULD: API route handlers, server components, and server actions SHOULD be declared as async functions when performing I/O operations.

### Verify

```bash
# Count promise chain usage
...
# Check for async/await best practice violations
