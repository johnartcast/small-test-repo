...
- **R-TS-001** SHOULD: Modules SHOULD export explicit TypeScript interfaces or types for public APIs.
...
<enforcement>
Claude Code MUST NOT skip or defer verification. Pre-commit hooks, CI/CD pipeline, and code review processes are mandatory enforcement points. TypeScript compilation errors MUST fail the build. Pull requests with new .js or .jsx files are automatically flagged for architectural review.
</enforcement>