...
- **R-PATH-001** MUST: Path validation MUST include normalization (resolving '..' and '.' segments) and verification that the resolved path remains within allowed directories.
