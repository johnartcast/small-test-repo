# Adopt Server-Side API Route Proxying for External API Integration: Routes Implement Rate
...
- **R-PROXY-001** SHOULD: API routes SHOULD implement rate limiting and caching strategies to optimize external API usage and costs.
