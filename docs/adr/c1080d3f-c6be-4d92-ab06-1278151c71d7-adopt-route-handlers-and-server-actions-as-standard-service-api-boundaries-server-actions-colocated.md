...
1. SHOULD: Server actions SHOULD be colocated with the UI components that invoke them to maintain feature cohesion

## Policy Block

- SHOULD Server actions SHOULD be colocated with the UI components that invoke them to maintain feature cohesion
