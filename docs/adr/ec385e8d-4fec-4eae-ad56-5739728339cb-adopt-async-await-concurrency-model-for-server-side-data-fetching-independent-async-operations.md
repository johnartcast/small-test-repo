...
1. SHOULD: Independent async operations SHOULD be executed in parallel using Promise.all() or Promise.allSettled() when appropriate

## Policy Block

- SHOULD Independent async operations SHOULD be executed in parallel using Promise.all() or Promise.allSettled() when appropriate
