...
1. MUST_NOT: New code MUST NOT introduce callback-based asynchronous patterns or nested promise chains when async/await syntax is available

## Policy Block

- MUST_NOT New code MUST NOT introduce callback-based asynchronous patterns or nested promise chains when async/await syntax is available
