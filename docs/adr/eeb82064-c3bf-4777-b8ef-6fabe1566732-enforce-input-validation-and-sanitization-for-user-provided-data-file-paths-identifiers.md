...
1. MUST: File paths and identifiers derived from user input MUST be validated against allowlists or normalized to prevent path traversal attacks

## Policy Block

- MUST File paths and identifiers derived from user input MUST be validated against allowlists or normalized to prevent path traversal attacks
