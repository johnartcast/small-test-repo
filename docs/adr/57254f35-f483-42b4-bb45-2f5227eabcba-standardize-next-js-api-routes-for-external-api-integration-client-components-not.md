...
1. MUST_NOT: Client components MUST NOT contain hardcoded API endpoints, credentials, or direct fetch calls to external third-party services

## Policy Block

- MUST_NOT Client components MUST NOT contain hardcoded API endpoints, credentials, or direct fetch calls to external third-party services
