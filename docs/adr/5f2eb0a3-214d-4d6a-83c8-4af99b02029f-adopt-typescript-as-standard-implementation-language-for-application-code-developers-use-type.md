...
1. MAY: Developers MAY use type inference where TypeScript can reliably infer types without ambiguity

## Policy Block

- MAY Developers MAY use type inference where TypeScript can reliably infer types without ambiguity
