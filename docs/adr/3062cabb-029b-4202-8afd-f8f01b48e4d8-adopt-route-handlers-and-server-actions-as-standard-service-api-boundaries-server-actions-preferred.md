...
1. SHOULD: Server Actions SHOULD be preferred over Route Handlers for form submissions and data mutations that are tightly coupled to UI components

## Policy Block

- SHOULD Server Actions SHOULD be preferred over Route Handlers for form submissions and data mutations that are tightly coupled to UI components
