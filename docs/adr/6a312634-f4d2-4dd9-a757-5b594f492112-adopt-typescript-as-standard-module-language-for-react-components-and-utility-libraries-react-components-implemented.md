...
1. MUST: All React components MUST be implemented using TypeScript with .tsx file extension

## Policy Block

- MUST All React components MUST be implemented using TypeScript with .tsx file extension
