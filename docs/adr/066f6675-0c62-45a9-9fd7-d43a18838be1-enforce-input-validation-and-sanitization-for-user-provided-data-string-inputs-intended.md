...
1. MUST: String inputs intended for display MUST be sanitized to prevent XSS attacks by escaping or removing potentially malicious content

## Policy Block

- MUST String inputs intended for display MUST be sanitized to prevent XSS attacks by escaping or removing potentially malicious content
