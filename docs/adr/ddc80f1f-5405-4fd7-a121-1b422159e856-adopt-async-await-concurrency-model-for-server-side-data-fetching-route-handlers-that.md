...
1. MUST: API route handlers that perform I/O operations MUST use async/await for all asynchronous operations

## Policy Block

- MUST API route handlers that perform I/O operations MUST use async/await for all asynchronous operations
