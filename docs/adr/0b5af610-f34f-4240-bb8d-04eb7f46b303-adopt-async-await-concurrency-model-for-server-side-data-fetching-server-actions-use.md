...
1. MAY: Server Actions MAY use async/await syntax for form submissions and mutations following the same patterns

## Policy Block

- MAY Server Actions MAY use async/await syntax for form submissions and mutations following the same patterns
