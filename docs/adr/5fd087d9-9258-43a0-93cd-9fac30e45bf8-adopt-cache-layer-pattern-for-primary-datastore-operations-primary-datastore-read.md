...
1. MUST: All primary datastore read operations for frequently accessed data MUST implement a cache layer between the application logic and the datastore

## Policy Block

- MUST All primary datastore read operations for frequently accessed data MUST implement a cache layer between the application logic and the datastore
