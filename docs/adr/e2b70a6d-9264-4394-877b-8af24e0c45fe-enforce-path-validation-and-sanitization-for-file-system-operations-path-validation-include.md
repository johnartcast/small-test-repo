# Enforce Path Validation and Sanitization for File System Operations: Path Validation Include
...
1. MUST: Path validation MUST include normalization (resolving '..' and '.' segments) and verification that the resolved path remains within allowed directories

## Policy Block

- MUST Path validation MUST include normalization (resolving '..' and '.' segments) and verification that the resolved path remains within allowed directories
