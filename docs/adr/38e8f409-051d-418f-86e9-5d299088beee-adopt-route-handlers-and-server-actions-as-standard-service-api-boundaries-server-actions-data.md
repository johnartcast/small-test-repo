...
1. MUST: Server actions for data mutations MUST be defined in actions.ts files colocated with their feature domains (e.g., app/[feature]/actions.ts)

## Policy Block

- MUST Server actions for data mutations MUST be defined in actions.ts files colocated with their feature domains (e.g., app/[feature]/actions.ts)
