...
1. MUST: Functions that return promises MUST be awaited when called within async contexts to ensure proper execution order and error propagation

## Policy Block

- MUST Functions that return promises MUST be awaited when called within async contexts to ensure proper execution order and error propagation
