...
1. SHOULD: Shared state management SHOULD use React Context API for application-wide concerns (e.g., ThemeContext)

## Policy Block

- SHOULD Shared state management SHOULD use React Context API for application-wide concerns (e.g., ThemeContext)
