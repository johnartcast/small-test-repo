...
1. MUST: API keys and authentication credentials MUST be stored in environment variables and accessed only in server-side code

## Policy Block

- MUST API keys and authentication credentials MUST be stored in environment variables and accessed only in server-side code
