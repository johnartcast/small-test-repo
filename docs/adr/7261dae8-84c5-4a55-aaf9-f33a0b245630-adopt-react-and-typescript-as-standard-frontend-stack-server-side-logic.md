...
1. SHOULD: Server-side logic in Next.js applications SHOULD be separated into server actions or API routes rather than mixed with client components

## Policy Block

- SHOULD Server-side logic in Next.js applications SHOULD be separated into server actions or API routes rather than mixed with client components
