...
1. MUST: Route handlers MUST export named functions corresponding to HTTP methods (GET, POST, PUT, DELETE, PATCH)

## Policy Block

- MUST Route handlers MUST export named functions corresponding to HTTP methods (GET, POST, PUT, DELETE, PATCH)
