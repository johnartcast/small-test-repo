...
1. MUST: Client components MUST interact with external APIs exclusively through internal API routes using relative paths

## Policy Block

- MUST Client components MUST interact with external APIs exclusively through internal API routes using relative paths
