...
1. MUST: React Server Components that fetch data MUST be declared as async functions

## Policy Block

- MUST React Server Components that fetch data MUST be declared as async functions
