...
1. MUST: Route Handlers MUST export named functions corresponding to HTTP methods (GET, POST, PUT, DELETE, PATCH) using Next.js conventions

## Policy Block

- MUST Route Handlers MUST export named functions corresponding to HTTP methods (GET, POST, PUT, DELETE, PATCH) using Next.js conventions
