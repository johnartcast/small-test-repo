...
1. MUST_NOT: Client components MUST NOT directly access database or external services; they MUST use route handlers or server actions

## Policy Block

- MUST_NOT Client components MUST NOT directly access database or external services; they MUST use route handlers or server actions
