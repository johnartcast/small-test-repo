...
1. MUST: Server Actions MUST include the 'use server' directive at the top of the file to explicitly mark server-only code

## Policy Block

- MUST Server Actions MUST include the 'use server' directive at the top of the file to explicitly mark server-only code
