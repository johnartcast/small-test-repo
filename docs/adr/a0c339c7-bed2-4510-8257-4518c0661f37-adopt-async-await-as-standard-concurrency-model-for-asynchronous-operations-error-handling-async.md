...
1. SHOULD: Error handling in async functions SHOULD use try-catch blocks rather than .catch() chains

## Policy Block

- SHOULD Error handling in async functions SHOULD use try-catch blocks rather than .catch() chains
