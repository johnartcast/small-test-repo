...
1. MUST: All asynchronous functions MUST be declared with the async keyword and use await for promise resolution rather than .then() chains or callbacks

## Policy Block

- MUST All asynchronous functions MUST be declared with the async keyword and use await for promise resolution rather than .then() chains or callbacks
