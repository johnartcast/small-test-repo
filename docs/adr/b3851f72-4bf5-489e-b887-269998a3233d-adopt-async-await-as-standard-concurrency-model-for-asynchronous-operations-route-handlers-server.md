# Adopt Async/Await as Standard Concurrency Model for Asynchronous Operations: Route Handlers Server
...
1. SHOULD: API route handlers, server components, and server actions SHOULD be declared as async functions when performing I/O operations

## Policy Block

- SHOULD API route handlers, server components, and server actions SHOULD be declared as async functions when performing I/O operations
