...
1. MUST: Cache keys MUST follow a consistent naming convention: `{service}:{resource}:{identifier}` (e.g., `weather:forecast:city123`, `todos:list:user456`)

## Policy Block

- MUST Cache keys MUST follow a consistent naming convention: `{service}:{resource}:{identifier}` (e.g., `weather:forecast:city123`, `todos:list:user456`)
