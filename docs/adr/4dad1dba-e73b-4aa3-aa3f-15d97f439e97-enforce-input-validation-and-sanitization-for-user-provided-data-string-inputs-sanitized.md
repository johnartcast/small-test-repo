...
1. MUST: String inputs MUST be sanitized to remove or escape potentially dangerous characters before storage or rendering

## Policy Block

- MUST String inputs MUST be sanitized to remove or escape potentially dangerous characters before storage or rendering
