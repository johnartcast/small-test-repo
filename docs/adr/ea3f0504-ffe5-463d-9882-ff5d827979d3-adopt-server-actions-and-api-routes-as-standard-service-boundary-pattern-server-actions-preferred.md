# Adopt Server Actions and API Routes as Standard Service Boundary Pattern: Server Actions Preferred
...
1. SHOULD: Server Actions SHOULD be preferred over API Routes for internal application mutations to leverage type safety and reduce boilerplate

## Policy Block

- SHOULD Server Actions SHOULD be preferred over API Routes for internal application mutations to leverage type safety and reduce boilerplate
