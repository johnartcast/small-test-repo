...
1. MUST_NOT: File system operations MUST NOT directly use unsanitized user input or external data as path components

## Policy Block

- MUST_NOT File system operations MUST NOT directly use unsanitized user input or external data as path components
