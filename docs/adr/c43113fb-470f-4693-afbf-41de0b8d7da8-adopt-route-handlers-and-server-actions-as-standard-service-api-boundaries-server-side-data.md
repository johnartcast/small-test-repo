...
1. MUST: Server-side data mutations and form actions MUST be implemented as Server Actions in actions.ts files, colocated with their feature modules

## Policy Block

- MUST Server-side data mutations and form actions MUST be implemented as Server Actions in actions.ts files, colocated with their feature modules
