...
1. SHOULD: Shared types and interfaces SHOULD be defined in dedicated type definition files or modules for reusability

## Policy Block

- SHOULD Shared types and interfaces SHOULD be defined in dedicated type definition files or modules for reusability
