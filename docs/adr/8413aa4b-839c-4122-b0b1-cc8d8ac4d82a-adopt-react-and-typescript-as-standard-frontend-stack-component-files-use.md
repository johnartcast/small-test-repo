...
1. MUST: Component files MUST use proper TypeScript type annotations for props, state, and function signatures

## Policy Block

- MUST Component files MUST use proper TypeScript type annotations for props, state, and function signatures
