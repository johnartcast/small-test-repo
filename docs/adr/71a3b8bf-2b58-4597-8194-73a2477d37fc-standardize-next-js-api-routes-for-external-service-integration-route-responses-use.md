...
1. SHOULD: API route responses SHOULD use TypeScript interfaces to define request and response contracts

## Policy Block

- SHOULD API route responses SHOULD use TypeScript interfaces to define request and response contracts
