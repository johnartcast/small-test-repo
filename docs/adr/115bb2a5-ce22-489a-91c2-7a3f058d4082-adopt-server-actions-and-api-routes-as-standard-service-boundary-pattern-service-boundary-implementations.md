...
1. SHOULD: Service boundary implementations SHOULD follow the Next.js App Router conventions with API Routes in app/api/* directories and Server Actions in component-adjacent action files

## Policy Block

- SHOULD Service boundary implementations SHOULD follow the Next.js App Router conventions with API Routes in app/api/* directories and Server Actions in component-adjacent action files
