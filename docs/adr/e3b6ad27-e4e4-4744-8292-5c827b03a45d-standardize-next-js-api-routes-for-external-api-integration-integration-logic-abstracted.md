...
1. SHOULD: API integration logic SHOULD be abstracted into library modules (src/lib/**) to promote reusability and testability

## Policy Block

- SHOULD API integration logic SHOULD be abstracted into library modules (src/lib/**) to promote reusability and testability
