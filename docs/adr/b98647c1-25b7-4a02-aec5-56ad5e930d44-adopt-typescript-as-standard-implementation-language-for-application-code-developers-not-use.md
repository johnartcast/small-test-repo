...
1. MUST_NOT: Developers MUST NOT use 'any' type except in exceptional cases with documented justification

## Policy Block

- MUST_NOT Developers MUST NOT use 'any' type except in exceptional cases with documented justification
