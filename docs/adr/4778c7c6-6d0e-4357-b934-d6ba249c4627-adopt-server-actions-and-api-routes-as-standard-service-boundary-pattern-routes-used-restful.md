...
1. MUST: API Routes MUST be used for RESTful endpoints that serve external clients, webhooks, or require standard HTTP method semantics (GET, POST, PUT, DELETE)

## Policy Block

- MUST API Routes MUST be used for RESTful endpoints that serve external clients, webhooks, or require standard HTTP method semantics (GET, POST, PUT, DELETE)
