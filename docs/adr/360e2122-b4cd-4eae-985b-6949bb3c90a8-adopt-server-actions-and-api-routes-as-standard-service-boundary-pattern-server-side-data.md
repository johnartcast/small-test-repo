...
1. MUST: All server-side data mutations and business logic MUST be implemented using either Next.js Server Actions or API Routes, never as client-side operations

## Policy Block

- MUST All server-side data mutations and business logic MUST be implemented using either Next.js Server Actions or API Routes, never as client-side operations
