...
1. SHOULD: Cache TTL values SHOULD be configurable via environment variables to allow tuning without code changes

## Policy Block

- SHOULD Cache TTL values SHOULD be configurable via environment variables to allow tuning without code changes
