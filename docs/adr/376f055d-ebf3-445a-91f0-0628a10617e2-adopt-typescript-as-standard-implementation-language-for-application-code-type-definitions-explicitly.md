...
1. SHOULD: Type definitions SHOULD be explicitly declared for function parameters, return values, and component props

## Policy Block

- SHOULD Type definitions SHOULD be explicitly declared for function parameters, return values, and component props
