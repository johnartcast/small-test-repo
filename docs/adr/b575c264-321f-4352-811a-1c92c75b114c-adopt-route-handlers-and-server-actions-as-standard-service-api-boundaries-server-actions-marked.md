...
1. MUST: Server actions MUST be marked with 'use server' directive at the file or function level

## Policy Block

- MUST Server actions MUST be marked with 'use server' directive at the file or function level
