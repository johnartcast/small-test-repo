...
1. SHOULD: Write operations (POST, PUT, DELETE) SHOULD invalidate relevant cache entries to maintain data consistency

## Policy Block

- SHOULD Write operations (POST, PUT, DELETE) SHOULD invalidate relevant cache entries to maintain data consistency
