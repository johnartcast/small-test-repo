...
1. MAY: Teams MAY use type inference where TypeScript can reliably infer types without explicit annotations

## Policy Block

- MAY Teams MAY use type inference where TypeScript can reliably infer types without explicit annotations
