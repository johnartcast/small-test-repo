...
1. MUST: Functions that call async functions MUST either await the result or explicitly handle the returned Promise

## Policy Block

- MUST Functions that call async functions MUST either await the result or explicitly handle the returned Promise
