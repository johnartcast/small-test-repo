# Adopt Async/Await as Standard Concurrency Model for Asynchronous Operations: Developers Use Promise
...
1. MAY: Developers MAY use promise methods like .finally() in conjunction with async/await for cleanup operations when it improves code clarity

## Policy Block

- MAY Developers MAY use promise methods like .finally() in conjunction with async/await for cleanup operations when it improves code clarity
