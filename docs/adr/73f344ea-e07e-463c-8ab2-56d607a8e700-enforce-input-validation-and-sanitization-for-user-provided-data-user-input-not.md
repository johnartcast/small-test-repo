...
1. MUST_NOT: User input MUST NOT be directly concatenated into SQL queries, shell commands, or HTML output without proper escaping

## Policy Block

- MUST_NOT User input MUST NOT be directly concatenated into SQL queries, shell commands, or HTML output without proper escaping
