...
1. MUST: All API routes that fetch data from external services or databases MUST implement a caching layer using Redis

## Policy Block

- MUST All API routes that fetch data from external services or databases MUST implement a caching layer using Redis
