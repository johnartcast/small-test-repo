...
1. MUST: Cache implementations MUST provide cache invalidation mechanisms to maintain consistency with the primary datastore

## Policy Block

- MUST Cache implementations MUST provide cache invalidation mechanisms to maintain consistency with the primary datastore
