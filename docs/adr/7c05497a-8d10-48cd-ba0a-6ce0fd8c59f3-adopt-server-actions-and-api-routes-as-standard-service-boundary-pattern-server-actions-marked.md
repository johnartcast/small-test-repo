...
1. MUST: All Server Actions MUST be marked with 'use server' directive and placed in dedicated action files (e.g., actions.ts)

## Policy Block

- MUST All Server Actions MUST be marked with 'use server' directive and placed in dedicated action files (e.g., actions.ts)
