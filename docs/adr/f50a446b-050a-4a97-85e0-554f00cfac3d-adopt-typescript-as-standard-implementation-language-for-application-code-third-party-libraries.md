...
1. SHOULD: Third-party libraries without native TypeScript support SHOULD have @types packages installed

## Policy Block

- SHOULD Third-party libraries without native TypeScript support SHOULD have @types packages installed
