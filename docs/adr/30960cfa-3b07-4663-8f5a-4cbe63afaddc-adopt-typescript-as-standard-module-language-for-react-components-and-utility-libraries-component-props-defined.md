...
1. SHOULD: Component props SHOULD be defined using TypeScript interfaces or type aliases

## Policy Block

- SHOULD Component props SHOULD be defined using TypeScript interfaces or type aliases
