...
1. SHOULD: API routes SHOULD implement request validation before calling external services

## Policy Block

- SHOULD API routes SHOULD implement request validation before calling external services
