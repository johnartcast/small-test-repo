...
1. MUST: Write operations to the primary datastore MUST invalidate or update relevant cache entries to prevent stale data

## Policy Block

- MUST Write operations to the primary datastore MUST invalidate or update relevant cache entries to prevent stale data
