...
1. MUST: API route handlers MUST be defined in route.ts files following Next.js App Router conventions (e.g., app/api/[resource]/route.ts)

## Policy Block

- MUST API route handlers MUST be defined in route.ts files following Next.js App Router conventions (e.g., app/api/[resource]/route.ts)
