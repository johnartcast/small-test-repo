...
1. MUST: Server Actions MUST be used for form submissions and data mutations that are tightly coupled to UI components and require type-safe integration

## Policy Block

- MUST Server Actions MUST be used for form submissions and data mutations that are tightly coupled to UI components and require type-safe integration
