...
1. MUST: API routes MUST handle authentication credentials and API keys server-side using environment variables, never exposing them to the client

## Policy Block

- MUST API routes MUST handle authentication credentials and API keys server-side using environment variables, never exposing them to the client
