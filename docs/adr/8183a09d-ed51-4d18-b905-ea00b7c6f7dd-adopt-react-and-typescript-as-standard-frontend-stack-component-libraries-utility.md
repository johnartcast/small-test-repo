...
1. SHOULD: Component libraries and utility modules SHOULD be organized in dedicated directories (src/components, src/lib) with clear separation of concerns

## Policy Block

- SHOULD Component libraries and utility modules SHOULD be organized in dedicated directories (src/components, src/lib) with clear separation of concerns
