...
1. MUST_NOT: New JavaScript (.js or .jsx) files MUST NOT be added to the codebase without explicit architectural approval

## Policy Block

- MUST_NOT New JavaScript (.js or .jsx) files MUST NOT be added to the codebase without explicit architectural approval
