...
1. MUST_NOT: Server components MUST NOT use callback-based async patterns (e.g., callback functions passed to setTimeout, fs.readFile with callbacks)

## Policy Block

- MUST_NOT Server components MUST NOT use callback-based async patterns (e.g., callback functions passed to setTimeout, fs.readFile with callbacks)
