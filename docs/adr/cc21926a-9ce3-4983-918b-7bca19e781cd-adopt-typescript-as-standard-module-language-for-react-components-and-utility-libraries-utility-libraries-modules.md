...
1. MUST: All utility libraries and modules MUST be implemented using TypeScript with .ts file extension

## Policy Block

- MUST All utility libraries and modules MUST be implemented using TypeScript with .ts file extension
