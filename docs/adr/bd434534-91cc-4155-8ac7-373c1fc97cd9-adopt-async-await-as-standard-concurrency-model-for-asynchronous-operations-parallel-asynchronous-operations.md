# Adopt Async/Await as Standard Concurrency Model for Asynchronous Operations: Parallel Asynchronous Operations
...
1. SHOULD: Parallel asynchronous operations SHOULD use Promise.all() or Promise.allSettled() with await rather than sequential await calls when operations are independent

## Policy Block

- SHOULD Parallel asynchronous operations SHOULD use Promise.all() or Promise.allSettled() with await rather than sequential await calls when operations are independent
