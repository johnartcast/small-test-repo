...
1. SHOULD: Cache keys SHOULD be deterministic and based on query parameters to ensure consistent cache hit rates

## Policy Block

- SHOULD Cache keys SHOULD be deterministic and based on query parameters to ensure consistent cache hit rates
