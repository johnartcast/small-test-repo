...
1. MUST: All file paths derived from external inputs, user requests, or configuration MUST be validated before use in file system operations

## Policy Block

- MUST All file paths derived from external inputs, user requests, or configuration MUST be validated before use in file system operations
